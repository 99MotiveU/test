...
public class MafiaGResult extends JFrame {
    ...
    public MafiaGResult(String username, boolean isWinner) {
        ...
        resultLabel.setFont(new Font("Malgun Gothic", Font.BOLD, 48));
        ...
        // 이미지
        String imagePath = isWinner ? "src/result1.png" : "src/result2.png";
        ...
        Image resizedQuit = quitIcon.getImage().getScaledInstance(100, 40, Image.SCALE_SMOOTH);
        Image resizedPlay = playIcon.getImage().getScaledInstance(140, 40, Image.SCALE_SMOOTH);
        ...
        againButton.setPreferredSize(new Dimension(140, 40));
